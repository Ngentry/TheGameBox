<%@ Page Title="" Language="C#" MasterPageFile="~/WebPage.Master" AutoEventWireup="true" CodeBehind="GroupCalendar.aspx.cs" Inherits="TheGameBox.WebForm9" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <h1><asp:Label ID="UserNamePageLbl" runat="server" Text="Label"></asp:Label>'s Group Calendar</h1>
