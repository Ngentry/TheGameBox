<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="Game_Control.aspx.cs" Inherits="TheGameBox.WebForm8" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
         <ItemTemplate>
             ...
             <asp:LinkButton ID="btnEdit" runat="server" CausesValidation="false" CommandName="Edit" Text="Edit"></asp:LinkButton>
              ...
              <asp:LinkButton ID="btnInsert" runat="server" CausesValidation="false" CommandName="New" Text="New"></asp:LinkButton>
         </ItemTemplate>
        <EditItemTemplate>
            <style>
                 td:first-child 
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TheGameBoxConnectionString %>" 
        DeleteCommand="DELETE FROM [Games] WHERE [Game_Id] = @Game_Id" 
        InsertCommand="INSERT INTO [Games] ([Game_Title], [Gane_Genre], [Game_Publisher], [Game_Author], [Game_Version], [Game_Image], [Game_MinPlayers], [Game_MaxPlayers], [Game_Description]) VALUES (@Game_Title, @Gane_Genre, @Game_Publisher, @Game_Author, @Game_Version, @Game_Image, @Game_MinPlayers, @Game_MaxPlayers, @Game_Description)" 
